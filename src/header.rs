...
impl Header {
    pub(crate) fn compute_new(
        primary: bool,
        _pp: &BTreeMap<u32, partition::Partition>, // FIXME: Why is this not used?
        guid: uuid::Uuid,
        backup_offset: u64,
